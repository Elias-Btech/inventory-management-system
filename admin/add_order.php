...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($customer_name) || empty($products)) {
        ...
        if (empty($valid_items)) {
            ...
            try {
                // Insert order
                $order_stmt = $conn->prepare("INSERT INTO orders (order_number, customer_name, customer_email, customer_phone, customer_address, total_amount, notes, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
